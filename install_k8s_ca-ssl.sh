...
############################## Create certificate file for metric server ######################################
...
# Generate proxy-client.pem and proxy-client-key.pem
cd $CA_DIR
cfssl gencert -ca=ca.pem -ca-key=ca-key.pem -config=ca-config.json -profile=kubernetes flannel-csr.json | cfssljson -bare proxy-client
echo ".........................................................................."
echo "INFO: Create  flannel.pem and flannel-key.pem successd..."
...
#worker
sudo ansible worker_k8s_vgs -m  copy -a "src=${CA_DIR}/ca.pem  dest=${CA_DIR}/" -b
